...
public class MainActivity extends AppCompatActivity {
    ...
    private static String file_url = "http://www.techotopia.com/images/f/f7/Android_activity_lifecycle_diagram.png";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Progress Bar
        btnShowProgress = (Button) findViewById(R.id.buttonImage);
